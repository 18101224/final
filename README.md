...
<html>
    ...
    <body>
        ...
        <img src="/data/pcr캡처.png"><img src="백신캡처.png" width=60% heing=60%><br>
        ...
        라고 생각하고 직접 구성한 함수입니다. <br>제가 추출한 특징으로는 일단 확진자수가 진동형태로 증가하며, 주기가 2배가 되고,
