...
<html>
    ...
    <body>
        ...
        <h5>백신에 대한 데이터 작성</h5>
        <img scr="/data/판다스.png"><br>
        백신 종류별로 회귀분석을 하기 위하여 dictionary형태로 pandas의 Series를 만들기위한 전처리입니다. 백신 접종은 2021년 2월에 시작됐기때문에 확진자 정보를 2021년 2월이후로 잘라주었습니다.
        <h5>백신 접종과 사망률</h5>
        ...
        <img src="/data/검은색함수.png"><br><br>
         ...
         <img src="/data/보정후그래프.png"><br>
         그 후 한 종류의 백신으로 전체백신접종률을 달성하게 된다면 사망률이 어떻게 될 것인지를 분석해보았습니다.
         <img src="/data/끝값.png"><img src="/data/백신2.png"><img src="/data/끝값결과.png"><br>
         결과에서 나오듯 화이자는 음의 값으로 사망률이 0에 가까울 것이고, AZ,모더나 순으로 아스트라제네카는 1퍼센트 미만, 모더나는 1퍼센트 2퍼센트 미만의 사망률을 보일것으로 보이며, 화이자, 아스트라제네카, 모더나 순으로 결과가 좋습니다.
         <h1>보완할 점</h1>
